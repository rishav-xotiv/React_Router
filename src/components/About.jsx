  ...
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      ...
      <p className="mb-4 text-slate-700">
        Real Estate stands as a leading real estate agency, excelling in the
        buying, selling, and renting of properties in top neighborhoods. Our
        team of seasoned agents is committed to delivering outstanding service
        and making every transaction as smooth as possible.
      </p>
      <p className="mb-4 text-slate-700">
